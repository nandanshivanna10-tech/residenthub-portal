        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-5 text-center h-fit transition-colors">
          <div className="relative w-20 h-20 mx-auto mb-3">
            {profilePhoto ? (
              ...
              <div className="w-20 h-20 rounded-full bg-purple-100 dark:bg-purple-950 flex items-center justify-center text-2xl font-semibold text-purple-600 dark:text-purple-400">
            ...
            <button
              ...
              className="absolute bottom-0 right-0 bg-purple-600 text-white rounded-full p-1.5 border-2 border-white dark:border-gray-900 disabled:opacity-60"
              title="Change photo"
            >
              <Camera size={14} />
            </button>
